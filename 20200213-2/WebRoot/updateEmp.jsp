  ...
  <body>
   <%
    		...
    		%>
    			...
    			<table>
    				<input type="hidden" name="operator" value="updateEmp"/>
    				<input type="hidden" name="empno" value="<%=emp.getEmpno()%>"/>
    				<tr>
    					<td>ename:</td>
    					<td><input type="text" name="ename" id="ename" value="<%=emp.getEname()%>"/></td>
    				</tr>
    				<tr>
    					<td>job:</td>
    					<td><input type="text" name="job" id="job" value="<%=emp.getJob()%>"/></td>
    				</tr>
    				<tr>
    					<td>sal:</td>
    					<td><input type="text" name="sal" id="sal" value="<%=emp.getSal()%>"/></td>
    				</tr>
    				<tr>
    					<td>comm:</td>
    					<td><input type="text" name="comm" id="comm" value="<%=emp.getComm()%>"/></td>
    				</tr>
    				<tr>
